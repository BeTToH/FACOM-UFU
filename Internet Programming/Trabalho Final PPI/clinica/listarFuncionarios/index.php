...
try{
    $sql = <<<SQL
        SELECT nome, sexo, email, telefone, cep, logradouro, cidade, estado,
               data_contrato, salario, especialidade, crm
        FROM pessoa pe
        INNER JOIN funcionario fu on pe.codigo = fu.codigo
        LEFT JOIN medico med on pe.codigo = med.codigo        
    SQL;
    $stmt = $pdo->query($sql);
}catch (Exception $e){
            ...
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                ...
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu drop-menu" aria-labelledby="navbarDropdownList">
                        <li class="nav-item">
                            <a class="nav-link ativo" href="../listarFuncionarios">Funcionários</a>
                        </li>
                        <li class="nav-item">
