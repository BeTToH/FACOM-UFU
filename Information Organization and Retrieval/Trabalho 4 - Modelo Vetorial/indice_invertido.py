...
# Gera arquivo Indice Invertido
def gera_arquivo_indice_invertido(dict_indice_invertido):
...
def get_indice_invertido(docs, base_dir):
    ...
    return dict_indice_invertido, dict_arquivos
